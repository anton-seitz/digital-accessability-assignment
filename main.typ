...
= Ansätze und Methodik

Um die vielfältigen Ansätze zusammenzuführen, wurden folgende Schwerpunkte gesetzt:

• Adaptive visuelle Aufbereitung: Inhalte werden individuell mittels Filterfunktionen an die verbleibende Sehleistung angepasst (@Rottensteiner2023).

• VR-Trainingsumgebungen: Simulation realitätsnaher Verkehrsszenarien und Innenräume zur Schulung von Mobilitäts- und Orientierungskompetenzen (@VR4VIP2022).

• Haptische Feedbacksysteme: Evaluierung unterschiedlicher haptischer Reize (Vibration vs. Haut-Stretch) zur Darstellung räumlicher Informationen (@Ricci2023, @Li2024).

• KI-basierte Szeneninterpretation: Einsatz von Vision Language Models und sprachgesteuerten Interaktionen zur Verbesserung der Objekterkennung in VR (@Chen2025).

Die methodische Herangehensweise umfasst die Integration dieser Technologien in eine VR-Plattform, die sowohl in kontrollierten Experimenten als auch in praxisnahen Trainingsszenarien getestet wird.
